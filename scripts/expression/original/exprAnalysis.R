...
#samtools view /home/escott/workspace/toe1/clean/npcControl.sort.bam | \
    #cat header.sam - | sed s/chr// | samtools view -Sb - > npcControl.b37.bam
...
resdir <- file.path(maindir,"results/wfamily")
