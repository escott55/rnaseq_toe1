...
resdir <- file.path(maindir,"results/all")
...
## ------------------------------------------------------------------------
#csvfile <- file.path(maindir,"sample_table.csv")
#csvfile <- file.path(maindir,"raw/newnpc/SampleTable.txt")
csvfile1 <- file.path(maindir,"raw/fibroblast/SampleTable.txt")
csvfile2 <- file.path(maindir,"raw/newnpc/SampleTable.txt")

st1 <- read.csv(csvfile1,row.names=1,sep="\t",comment.char="#")
st2 <- read.csv(csvfile2,row.names=1,sep="\t",comment.char="#")

sampleTable <- rbind(st1, st2)
sampleTable$Family <- paste("fam",sampleTable$Family,sep="")
#sampleTable$id <- as.factor(paste(sampleTable$Family,sampleTable$Member,
                                  #sampleTable$Status,sep="_"))
