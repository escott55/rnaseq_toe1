...
resdir <- file.path(maindir,"results/oldnpc")
...
# Old NPC data
#RL01 - ATCC
#RL02 - 1603A1 (clone 1 from 1603A)
#RL03 - 1603A3 (clone 2 from 1603A)
#RL04 - 1603U3 (clone 1 from 1603U)
#RL05 - 1603U4 (clone 2 from 1603U)

## ------------------------------------------------------------------------
print("Read in the SampleTable")
print(csvfile)
...
sampleTable <- sampleTable[ sampleTable$Batch == 1, ] # Use only batch1
